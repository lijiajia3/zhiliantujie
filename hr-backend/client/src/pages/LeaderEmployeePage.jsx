...
export default function LeaderEmployeePage() {
  ...
  const fetchEmployees = async () => {
    try {
      const res = await axios.get("/leader/employees", { withCredentials: true });
  ...
  const handlePromotion = async (emp) => {
    try {
    const res = await axios.post("/llm/promotion", emp);
  ...
  const handleDismissal = async (emp) => {
    try {
    const res = await axios.post("/llm/dismissal", emp);
        ...
        <button
          onClick={async () => {
            ...
            try {
              ...
              const res = await axios.post("/leader/add-by-id", { id }, { withCredentials: true });
