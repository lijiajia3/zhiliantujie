...
class Page(Container):
    ...
    def process_object(self, obj: LTItem) -> T_obj:
        ...
        if isinstance(obj, LTChar):
            ...
            attr["path"] = [(cmd, *map(self.point2coord, pts)) for cmd, *pts in obj.original_path]  
    ...
    def to_image(
        ...
        if num_specs > 1:
            raise ValueError(
                f"Only one of these arguments can be provided: resolution, width, height. You provided {num_specs}"  
            )
